...
"Por causa da instrução dentro da classe .tech no arquivo css."  
...
//não consegui pensar ela e tive que recorrer ao gabarito;
...
//não consegui acertar a função e tive que recorrer ao gabarito;
// 4. Crie uma função que, ao clicar duas vezes em 'Meu top 3 do Spotrybefy', ele
// redirecione para alguma página;
// 4.1. Que tal redirecionar para seu portfólio?
myWebpage.addEventListener('dblclick', function() {
    window.location.replace('https://gabrielaguiardantas.github.io/');
});
