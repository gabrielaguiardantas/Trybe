...
if __name__ == "__main__":
    ...
    print(linked_list)
    """saída: LinkedList(len=2 value=
    Node(value=2 next=Node(value=1 next=None)))"""

    linked_list.insert_last(3)
    print(linked_list)
    """saída: LinkedList(len=3 value=
    Node(value=2 next=Node(value=1 next=Node(value=3 next=None))))"""
    ...
    print(linked_list)
    """saída: LinkedList(len=2 value=
    Node(value=1 next=Node(value=5 next=None)))"""
