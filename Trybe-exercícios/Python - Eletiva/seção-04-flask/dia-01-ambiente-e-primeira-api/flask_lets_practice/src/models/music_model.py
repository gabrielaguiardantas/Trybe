...
class MusicModel(AbstractModel):
    # Define que a Coleção do Banco se chamara musics.
    ...
    # Retornar uma musica aleatória, é uma regra de negócio especifica
    # Fazendo sentido manter somente para a model music
    @classmethod
    def get_random(cls):
        data = cls.find()
        if not data:
