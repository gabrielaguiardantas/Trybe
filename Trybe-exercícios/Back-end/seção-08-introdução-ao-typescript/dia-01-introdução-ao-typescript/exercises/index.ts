...
console.log(`- Losango com diagonal maior 32cm e menor 18cm: ${Ex.getLozengeArea(32, 18)}cm²`);
console.log(`- Losango com diagonal maior 32cm e menor 18cm: ${Ex.getLozengeArea(200, 50)}cm²`);
console.log(`- Losango com diagonal maior 32cm e menor 18cm: ${Ex.getLozengeArea(75, 25)}cm²`);

console.log(`- Trapézio de base maior 100cm, menor 70cm e altura 50cm: ${Ex.getTrapeziumArea(70, 100, 50)}cm²`);
console.log(`- Trapézio de base maior 100cm, menor 70cm e altura 50cm: ${Ex.getTrapeziumArea(50, 75, 35)}cm²`);
console.log(`- Trapézio de base maior 100cm, menor 70cm e altura 50cm: ${Ex.getTrapeziumArea(120, 150, 80)}cm²`);
